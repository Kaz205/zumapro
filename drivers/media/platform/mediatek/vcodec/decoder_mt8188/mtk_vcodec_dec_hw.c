...
static const struct of_device_id mtk_vdec_hw_match[] = {
	{
		.compatible = "mediatek,mtk-vcodec-lat-mt8188",
		.data = (void *)MTK_VDEC_LAT0,
	},
	{
		.compatible = "mediatek,mtk-vcodec-core-mt8188",
		.data = (void *)MTK_VDEC_CORE,
	},
	{
		.compatible = "mediatek,mtk-vcodec-lat-soc-mt8188",
...
static int mtk_vdec_hw_probe(struct platform_device *pdev)
{
	...
	ret = mtk_vcodec_init_dec_clk_mt8188(pdev, &subdev_dev->pm);
	if (ret)
		return ret;
